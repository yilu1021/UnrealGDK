...
call :MarkStartOfBlock "Retrieve dependencies"
    ...
    spatial package retrieve worker_sdk      c_headers                                  %PINNED_CORE_SDK_VERSION%   "%CORE_SDK_DIR%\worker_sdk\c_headers.zip" %DOMAIN_ENVIRONMENT_VAR%
    spatial package retrieve worker_sdk      c-dynamic-x86-vc140_md-win32               %PINNED_CORE_SDK_VERSION%   "%CORE_SDK_DIR%\worker_sdk\c-dynamic-x86-vc140_md-win32.zip" %DOMAIN_ENVIRONMENT_VAR%
    spatial package retrieve worker_sdk      c-dynamic-x86_64-vc140_md-win32            %PINNED_CORE_SDK_VERSION%   "%CORE_SDK_DIR%\worker_sdk\c-dynamic-x86_64-vc140_md-win32.zip" %DOMAIN_ENVIRONMENT_VAR%
    spatial package retrieve worker_sdk      c-dynamic-x86_64-gcc510-linux              %PINNED_CORE_SDK_VERSION%   "%CORE_SDK_DIR%\worker_sdk\c-dynamic-x86_64-gcc510-linux.zip" %DOMAIN_ENVIRONMENT_VAR%
    spatial package retrieve worker_sdk      c-static-fullylinked-arm-clang-ios         %PINNED_CORE_SDK_VERSION%   "%CORE_SDK_DIR%\worker_sdk\c-static-fullylinked-arm-clang-ios.zip" %DOMAIN_ENVIRONMENT_VAR%
